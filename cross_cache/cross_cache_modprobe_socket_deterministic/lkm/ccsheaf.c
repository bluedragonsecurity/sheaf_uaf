/*
 * vulnerable UAF lkm - socket communication
 * kratnowl cross cache method
 * Antonius (sw0rdm4n / ev1lut10n / w1sdom) - bluedragonsec.com
 */
...
#define CCS_O_ALLOC      1   
#define CCS_O_ALLOC_CG   2   
#define CCS_O_FREE       3   
#define CCS_O_PEEK       4    
#define CCS_O_POKE       5    
#define CCS_O_SYNC       6    
#define CCS_O_RESET      7   
