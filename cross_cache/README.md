...
>Cross cache UAF exploitation pOc for linux kernel 7.0 slub sheaves.  Cross-cache strategy is adapted from cross-x (complete free). Tested on linux 7.0 - lubuntu 26.
...
>Cross cache UAF exploitation pOc for linux kernel 7.0 when the object has no sheaves, using function pointer hijack for LPE. An UAF read for information leak & UAF write for LPE. Tested on linux 7.0 - lubuntu 26.
