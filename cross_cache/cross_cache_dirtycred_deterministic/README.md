...
mechanism:
 ...
 Step 3 .free BURNER_PRE  -> saturasi sheaves+barn + raise nr_partial
 Step 4. free V (TARGET pool) -> 64 dangling slots di slabs 0..3
 Step 5. free F (filler)  -> lengkapi slab 3 -> inuse=0
 Step 6. free BURNER_POST -> trigger flush event yg discard
 Step 7. reclaim spray open(/etc/passwd) x NSPRAY -> filp_cachep grab halaman fresh dari buddy
